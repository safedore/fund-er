...
<head>
	<title>Luxury Homes a Real Estates Category Bootstrap Responsive Web Template | Mail :: w3layouts</title>
	<!-- for-mobile-apps -->
				...
				<div class="container">
					<nav class="navbar navbar-default">
						<div class="navbar-header">
							...
							<h1><a href="index.html"><span>L</span>uxury <span>H</span>omes</a></h1>
						</div>
						<!--navbar-header-->
		...
		<div class="container">
			<div class="w3_footer_grids">
				<div class="col-md-4 w3_footer_grid-main">
					<h2><a href="index.html"><span>L</span>uxury <span>H</span>omes</a></h2>
